...
const MESSAGES = {
  ...
  RETURNED_SOL: (solBalance, transactionSignature) => `\n🔄 Returned ${escapeMarkdown(solBalance.toFixed(9))} SOL to sender\\. \nTransaction signature: [${escapeMarkdown(transactionSignature)}](https://solscan.io/tx/${escapeMarkdown(transactionSignature)})`,
