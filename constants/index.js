...
const MESSAGES = {
  ...
  SOL_BALANCE_A: (solBalance) => `\n💰 SOL Balance is: ${escapeMarkdown(solBalance.toFixed(9))} SOL`,
  ...
  RETURNED_SOL: (solBalance, transactionSignature) => `\n🔄 Returned ${escapeMarkdown(solBalance.toFixed(9))} SOL to sender. Transaction signature: [${escapeMarkdown(transactionSignature)}](https://solscan.io/tx/${escapeMarkdown(transactionSignature)})`,
